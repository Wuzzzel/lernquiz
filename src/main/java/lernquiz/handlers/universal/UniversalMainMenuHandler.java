...
public class UniversalMainMenuHandler implements RequestHandler {
    ...
    public boolean canHandle(HandlerInput input) {
        return input.matches(intentName("UniversalMainMenu"));
    }
    ...
    public Optional<Response> handle(HandlerInput input) {
        ...
        if(state.equals(Attributes.START_STATE)) {
            ...
            responseText = Constants.MAIN_MENU_NEWBIE_MESSAGE;   //TODO: Das ist hier so ziemlich das gleiche wie in der QuizAnotherQuestionHandler geschichte
        }
        sessionAttributes.put(Attributes.STATE_KEY, Attributes.START_STATE);
        sessionAttributes.put(Attributes.RESPONSE_KEY, Constants.MAIN_MENU_NEWBIE_MESSAGE); //Beim Universal Wiederhole, soll aber die normale Hauptmenü Response folgen
